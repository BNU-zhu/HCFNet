...
The official PyTorch implementation of "A deep learning method for field boundaries delineation from remote sensing imagery with high boundary connectivity".<br>
